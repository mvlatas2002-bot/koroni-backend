    ...
    <main class="content">
        ...
        <section class="surface">
            <div class="panel-head">
                ...
                <span class="info-dot" data-tip="Ο προϊστάμενος είναι η βασική διαδρομή έγκρισης. Η δεύτερη έγκριση χρησιμοποιείται όταν ο κανόνας ή η απουσία το απαιτεί.">?</span>
            </div>
